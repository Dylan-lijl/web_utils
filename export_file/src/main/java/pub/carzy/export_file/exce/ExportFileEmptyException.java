...
public class ExportFileEmptyException extends ExportBaseException{
    ...
    public ExportFileEmptyException(String message, Throwable cause) {
        super(message, cause);
    }
    ...
    protected ExportFileEmptyException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
