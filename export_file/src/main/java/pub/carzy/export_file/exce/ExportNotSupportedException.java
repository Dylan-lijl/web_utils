 ...
 * @version 1.0
 */
public class ExportNotSupportedException extends ExportBaseException{
    ...
    protected ExportNotSupportedException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
