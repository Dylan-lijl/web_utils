...
public class CommonResult<T> {
    ...
    public static <T> CommonResult<T> successCreate() {
        return new CommonResult<T>(ResultCodeEnum.SUCCESS_CREATE.getCode(), ResultCodeEnum.SUCCESS_CREATE.getMessage(), null);
    }
    /**
     * 修改成功
     * @param <T>
    ...
    public static <T> CommonResult<T> successUpdate() {
        return new CommonResult<T>(ResultCodeEnum.SUCCESS_UPDATE.getCode(), ResultCodeEnum.SUCCESS_UPDATE.getMessage(), null);
    }
    ...
    public static <T> CommonResult<T> successDelete() {
        return new CommonResult<T>(ResultCodeEnum.SUCCESS_DELETE.getCode(), ResultCodeEnum.SUCCESS_DELETE.getMessage(), null);
    }
     ...
     * @param errorCode 错误码
     */
    public static <T> CommonResult<T> failed(CodeEnum errorCode) {
     ...
     * @param message 错误信息
     */
    public static <T> CommonResult<T> failed(CodeEnum errorCode, String message) {
